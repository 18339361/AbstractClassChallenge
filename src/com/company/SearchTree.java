...
public class SearchTree implements NodeList {
    ...
    public boolean addItem(ListItem newItem) {
        if(this.root == null){
            //the tree was empty, so out item becomes the new root
            this.root = newItem;
            return true;
        }
        ...
        while(currentItem != null){//condition is never false but return gets us out of this
            ...
            if(comparison < 0){
                ...
                if(currentItem.next() != null){
                    ...
                    //there's no node to the rigth, so add at this point
